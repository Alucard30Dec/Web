...
public static class DbInitializer
{
    ...
    {
        // KHÔNG dùng EnsureCreated khi đi theo Migrations
        // Việc tạo schema sẽ do Migrate() + migration đảm nhiệm.
        ...
        {
            new() { FirstMidName="Carson",   LastName="Alexander", EnrollmentDate=DateTime.Parse("2022-09-01") },
            new() { FirstMidName="Meredith", LastName="Alonso",    EnrollmentDate=DateTime.Parse("2022-09-01") },
            new() { FirstMidName="Arturo",   LastName="Anand",     EnrollmentDate=DateTime.Parse("2023-09-01") },
            new() { FirstMidName="Gytis",    LastName="Barzdukas", EnrollmentDate=DateTime.Parse("2023-09-01") },
            new() { FirstMidName="Yan",      LastName="Li",        EnrollmentDate=DateTime.Parse("2023-09-01") },
            new() { FirstMidName="Peggy",    LastName="Justice",   EnrollmentDate=DateTime.Parse("2024-09-01") },
            new() { FirstMidName="Laura",    LastName="Norman",    EnrollmentDate=DateTime.Parse("2024-09-01") },
            new() { FirstMidName="Nino",     LastName="Olivetto",  EnrollmentDate=DateTime.Parse("2024-09-01") }
        };
